...
# Pre process dataset.
X_train = train_data[['dyn_prop','rcs','vx_comp','ambig_state','x_rms','y_rms','invalid_state','vx_rms','vy_rms']]
y_train = train_data['BasicCategoryNum']

X_test  = test_data[['dyn_prop','rcs','vx_comp','ambig_state','x_rms','y_rms','invalid_state','vx_rms','vy_rms']]
...
filename= 'McSVM_no_xy_vycomp_pdh0.sav' 
